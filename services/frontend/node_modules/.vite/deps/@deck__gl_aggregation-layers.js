import {
  ...
  project32_default,
  viewport_default
} from "./chunk-ED6QRBU3.js";
import "./chunk-DMRCQWYU.js";
import {
  __commonJS,
  __toESM
...
var uniformBlock5 = `layout(std140) uniform arcUniforms {
  bool greatCircle;
...
var uniformBlock6 = `layout(std140) uniform bitmapUniforms {
  vec4 bounds;
...
var uniformBlock7 = `layout(std140) uniform iconUniforms {
  float sizeScale;
...
var uniformBlock8 = `layout(std140) uniform columnUniforms {
  float radius;
  float angle;
  vec2 offset;
  bool extruded;
...
var uniformBlock9 = `layout(std140) uniform pathUniforms {
  float widthScale;
  float widthMinPixels;
  float widthMaxPixels;
  float jointType;
...
var uniformBlock10 = `layout(std140) uniform solidPolygonUniforms {
  bool extruded;
  bool isWireframe;
  float elevationScale;
} solidPolygon;
...
var uniformBlock11 = `layout(std140) uniform sdfUniforms {
  float gamma;
  bool enabled;
  float buffer;
  float outlineBuffer;
...
var uniformBlock12 = `layout(std140) uniform textBackgroundUniforms {
  bool billboard;
  float sizeScale;
  float sizeMinPixels;
  float sizeMaxPixels;
...
var uniformBlock18 = `layout(std140) uniform triangleUniforms {
...
var uniformBlock19 = `layout(std140) uniform weightUniforms {
  vec4 commonBounds;
  float radiusPixels;
  float textureWidth;
  float weightsScale;
